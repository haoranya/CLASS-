<?php 
	...
	class StudentModel extends Model {
		...
		function initcon($data){
			$sql = "insert into ".$this->getTableName()." (id,stu_name,stu_phone,stu_e_phone,leave_type,content,leave_time,back_time) values(null,:stu_name,:stu_phone,:stu_e_phone,:leave_type,:content,:leave_time,:back_time)";
			var_dump($sql,$data);
			return $this->exec($sql,$data);
		}
