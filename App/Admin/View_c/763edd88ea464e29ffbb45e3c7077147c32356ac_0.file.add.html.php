<?php
/* Smarty version 3.1.30, created on 2018-04-17 15:15:01
  from "C:\www\dytt\App\Admin\View\Rules\add.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ad59ef54657e4_64116735',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '763edd88ea464e29ffbb45e3c7077147c32356ac' => 
    array (
      0 => 'C:\\www\\dytt\\App\\Admin\\View\\Rules\\add.html',
      1 => 1523949296,
      2 => 'file',
    ),
  ),
...
function content_5ad59ef54657e4_64116735 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
		...
		<div class="superCtab">
			<div class="publishArt">
				...
				<div class="pubMain">
					...
					<form action="index.php?p=admin&c=rules&a=doAdd" method="post">
...
?>
						...
						<div class="pubselect">
							<span class="select_ui"><span class="select_text_ui" style="min-width: 6em;">请选择电影类型</span><b class="select_arrow"></b>
...
?>
						...
						<div class="pub-txt-bar">
							<input type="text" name="rulesname" class="shuruTxt">
						</div>
						...
						<h5 class="pubtitle">采集地址<br>（如需采集列表，请将页码括号括起来，http://www.dytt8.net/html/gndy/dyzz/list_23_{173}.html<br>如果是采集内容页请填写：http://www.dytt8.net）</h5>
						<div class="pub-txt-bar">
							<input type="text" class="shuruTxt" name="url" placeholder="http://www.dytt8.net">
						</div>

						<div class="lxfs-tzyx clearfix">
							<ul class="clearfix">
								<li><h5 class="pubtitle">开始页码（采集类型为内容 请设置为0）</h5>
									<input type="text" class="shuruTxt" name="start">
								</li>
								<li><h5 class="pubtitle">结束页码（采集类型为内容 请设置为0）</h5>
									<input type="text" class="shuruTxt" name="end">
								</li>
							</ul>
						</div>
