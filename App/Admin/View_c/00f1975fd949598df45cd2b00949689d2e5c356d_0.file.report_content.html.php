<?php
/* Smarty version 3.1.30, created on 2018-04-28 09:41:55
  from "C:\wamp64\www\App\Admin\View\Report\report_content.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5ae3d1634e43e9_31328819',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '00f1975fd949598df45cd2b00949689d2e5c356d' => 
    array (
      0 => 'C:\\wamp64\\www\\App\\Admin\\View\\Report\\report_content.html',
      1 => 1524879707,
      2 => 'file',
    ),
  ),
...
function content_5ae3d1634e43e9_31328819 (Smarty_Internal_Template $_smarty_tpl) {
if (!is_callable('smarty_modifier_date_format')) require_once 'C:\\wamp64\\www\\Vendor\\Smarty\\plugins\\modifier.date_format.php';
?>
<!DOCTYPE html>
...
" method="post">
						...
						<div class="pub-txt-bar">
							<input type="text" readonly  name="gz_title" class="shuruTxt" value="<?php echo $_smarty_tpl->tpl_vars['retGall']->value['gz_title'];?>
">
						</div>

						<h5 class="pubtitle">公司</h5>
						<div class="pub-txt-bar">
							<input type="text" name="gz_gongsi" readonly  class="shuruTxt" value="<?php echo $_smarty_tpl->tpl_vars['retGall']->value['gz_gongsi'];?>
">
						</div>
						...
						<div class="lxfs-tzyx clearfix">
							<ul class="clearfix">
								<li><h5 class="pubtitle">开始时间</h5>
									<input type="text" class="shuruTxt" name="gz_start_time" readonly  value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['retGall']->value['gz_start_time'],'%Y-%m-%d %H:%M:%S');?>
">
								</li>
								<li><h5 class="pubtitle">结束时间</h5>
									<input type="text" class="shuruTxt" name="gz_end_time" readonly  value="<?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['retGall']->value['gz_end_time'],'%Y-%m-%d %H:%M:%S');?>
">
								</li>
							</ul>
						</div>
						...
						<div class="pub-area-bar">
							<textarea name="gz_content" rows="" cols="3" readonly  height="400px"><?php echo $_smarty_tpl->tpl_vars['retGall']->value['gz_content'];?>
</textarea>
						</div>
