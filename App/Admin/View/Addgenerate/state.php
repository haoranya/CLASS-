          ...
          <div class="col-xs-8 content">
            ...
            <p class="p_1 p_one">起止日期：
              <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="leave_date" id="date" lay-verify="date" placeholder="" autocomplete="off" class="layui-input" value="<{$staArr.start_date}>" disabled="disabled">
                </div>
            </div>
            <span>--</span>
             <div class="layui-inline">
                ...
                <div class="layui-input-block">
                    <input type="text" name="back_date" id="date1" lay-verify="date" autocomplete="off" class="layui-input" value="<{$staArr.end_date}>" disabled="disabled">
                </div>
            </div>
          </p>

            <p class="p_2 p_two" id="name2"><{$staArr.name}></p>
            ...
            <p class="p_2 p_three">一、本阶段数据汇总</p>
              <table class="table-bordered table_left table_conter" >
                ...
                <tr>
                  <td><{$huizong.baifenbi}></td>
                  <td><{$huizong.kaoqin}></td>
                  <td><{$huizong.zhuangtai}></td>
                  <td><{$huizong.active}></td>
                  <td><{$huizong.shengbing}></td>
                </tr>
                <tr>
                  <td><button type="button" onclick="qqw(<{$staArr.id}>,1)" class="btn btn-success" data-toggle="modal" data-target="#loginModal" data-whatever="@mdo">修改</button></td>
                  <td><button type="button" onclick="qqw(<{$staArr.id}>,2)" class="btn btn-success" data-toggle="modal" data-target="#loginModal" data-whatever="@mdo">修改</button></td>
                  <td><button type="button" onclick="qqw(<{$staArr.id}>,3)" class="btn btn-success" data-toggle="modal" data-target="#loginModal" data-whatever="@mdo">修改</button></td>
                  <td><button type="button" onclick="qqw(<{$staArr.id}>,4)" class="btn btn-success" data-toggle="modal" data-target="#loginModal" data-whatever="@mdo">修改</button></td>
                  <td><button type="button" onclick="qqw(<{$staArr.id}>,5)" class="btn btn-success" data-toggle="modal" data-target="#loginModal" data-whatever="@mdo">修改</button></td>
                </tr>
                <td><a href="">刷新页面</a></td>
            ...
            <p class="p_title_one">1.作业评分（此数据来源于助理讲师每日批改作业的成绩）&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
              ...
              <table class="table-bordered table_left table_conter">
                ...
                <{foreach from=$stateArr item=$v}>
                <tr>
                  <td rowspan="3"><{$v.today_date}></td>
                  <td>上午</td>
                  <td><{$v.forenoon_state}></td>
                  
                </tr>
                <tr>
                  <td>下午</td>
                  <td><{$v.afternoon_state}></td>
                  
                </tr>
                <tr>
                  <td>晚自习</td>
                  <td><{$v.evening_state}></td>
